...
from F_taste_nutrizionista.controllers.disease_controller import DiseaseController,AllDiseaseController
from F_taste_nutrizionista.controllers.paziente_controller import DiseaseDelPazienteController,Paziente
from F_taste_nutrizionista.controllers.informativa_controller import InformativaPrivacy
 ...
 #   @api.errorhandler(NoResultFound)
  #  def handle_NoResultFound_error(error: NoResultFound):
   ...
   # @api.errorhandler(NoAuthorizationException)
    ...
    nutrizionista_ns.add_resource(DiseaseController, '/disease')
    nutrizionista_ns.add_resource(DiseaseDelPazienteController,'/disease_del_paziente')
    nutrizionista_ns.add_resource(AllDiseaseController,'/get_all_disease')
    nutrizionista_ns.add_resource(Paziente,'/paziente')
    nutrizionista_ns.add_resource(Pazienti,'/pazienti')
    nutrizionista_ns.add_resource(InformativaPrivacy,'/informativa_privacy')
